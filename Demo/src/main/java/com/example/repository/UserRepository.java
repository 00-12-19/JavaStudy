...
//    List<EntityUser> findUserData(String userName);
    ...
    @Modifying
    @Transactional    
    @Query(value = "DELETE FROM EntityUser WHERE username = :userName AND userage = :userAge")
    int deleteUserByNameAndAge(String userName, String userAge);
    
    List<EntityUser> findByUsernameAndUserage(String userName, String userAge);


    
//    @Query(value = "Select * From EntityUser")
//    List<EntityUser> findUserData(String userTitle, String userContents);
